...
export default function ReviewerLoginSidangSastraInggris() {
  ...
  useEffect(() => {
    const cachedEmail = localStorage.getItem(
      "sidang_sastra_inggris_reviewer_email"
    );
  ...
  const handleSubmit = (event) => {
    ...
    if (rememberMe) {
      localStorage.setItem("sidang_sastra_inggris_reviewer_email", email);
    } else {
      localStorage.removeItem("sidang_sastra_inggris_reviewer_email");
    }

    console.log("Login reviewer Sidang Sastra Inggris", { email, password });
  };
        ...
        <section className="relative hidden min-h-screen overflow-hidden bg-primary px-12 py-10 text-white lg:flex lg:flex-col lg:justify-between xl:px-16">
          ...
          <div className="relative mt-10 z-10 max-w-2xl">
            <div className="mb-3 inline-flex items-center gap-2 rounded-full bg-white/14 px-4 py-2 text-sm font-medium text-blue-50 ring-1 ring-white/20 backdrop-blur-xl">
              Penelaah SUP & Sidang Skripsi
            </div>

            <h2 className="max-w-xl text-5xl font-semibold leading-[1.04] tracking-[-0.04em]">
              Review pengajuan mahasiswa dengan lebih terarah.
            </h2>

            <p className="mt-6 max-w-xl text-base leading-8 text-blue-50/85">
              Portal khusus penelaah untuk melihat daftar mahasiswa bimbingan
              sidang, membaca dokumen, memberikan penilaian, mencatat feedback,
              dan mengirim keputusan evaluasi.
            </p>
          </div>
          ...
          <div className="relative z-10 mt-10 grid max-w-xl grid-cols-3 gap-4">
            <div className="group rounded-3xl bg-white/12 p-5 ring-1 ring-white/15 backdrop-blur-xl transition hover:bg-white/18">
              ...
              <p className="text-sm font-semibold">Review Dokumen</p>
              <p className="mt-1 text-xs leading-5 text-blue-50/70">
                Baca proposal dan berkas sidang mahasiswa.
              </p>
            </div>
            ...
            <div className="group rounded-3xl bg-white/12 p-5 ring-1 ring-white/15 backdrop-blur-xl transition hover:bg-white/18">
              ...
              <p className="mt-1 text-xs leading-5 text-blue-50/70">
                Isi nilai sesuai format penilaian sidang.
              </p>
            </div>
            ...
            <div className="group rounded-3xl bg-white/12 p-5 ring-1 ring-white/15 backdrop-blur-xl transition hover:bg-white/18">
              ...
              <p className="text-sm font-semibold">Feedback Akhir</p>
              <p className="mt-1 text-xs leading-5 text-blue-50/70">
                Berikan catatan evaluasi untuk mahasiswa.
              </p>
            </div>
          </div>
          ...
          <div className="mx-auto w-full max-w-[500px]">
            ...
            <div className="mb-10">
              ...
              <p className="mt-4 max-w-lg text-sm leading-7 text-slate-500">
                Masuk untuk meninjau dokumen, mengisi nilai, dan memberikan
                feedback sidang mahasiswa Sastra Inggris.
              </p>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    placeholder="nama.dosen@unikom.ac.id"
              ...
              >
                Masuk sebagai Penelaah
              </button>

              <p className="pb-10 text-sm leading-7 text-slate-500">
                Akses penelaah dikelola oleh koordinator program studi. Jika
                belum memiliki akses, hubungi admin atau koordinator terkait.
              </p>
            </form>
          </div>
        </section>
